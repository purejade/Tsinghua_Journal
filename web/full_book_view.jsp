    ...
    <table border="0" cellpadding="7" width="680">
        ...
        <tr>
            ...
            <td width="378" valign="top" align="left"><font color="#008080">
                ...
                %>
                <p>
                    <a href="/Tsinghua_Journal/turnPage?totalvolume=78&pageno=0">总第<%=totalVolume.get(i)%>期</a>&nbsp;&nbsp;&nbsp;
                        <% if(i+1 < totalVolume.size()) {  %>
                    <a href="/Tsinghua_Journal/turnPage?totalvolume=78&pageno=0">总第<%=totalVolume.get(i+1)%>期</a>&nbsp;&nbsp;&nbsp;
                        <% } %>
                     <% if(i+2 < totalVolume.size()) {  %>
                     <a href="/Tsinghua_Journal/turnPage?totalvolume=78&pageno=0">总第<%=totalVolume.get(i+2)%>期</a>&nbsp;&nbsp;&nbsp;&nbsp;</font>
                <% } %>
                </p>
                    <%
            }
