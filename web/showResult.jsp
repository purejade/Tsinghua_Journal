...
<table border="1" cellspacing="0" cellpadding="0" width="100%" style="align:center;">
    ...
    <tr>
        ...
        <%--<td> <a href="/Tsinghua_Journal/turnPage?totalvolume=${journal.totalvolume}&pageno=${journal.pageno}"> 阅读</a></td>--%>
        <td> <a href="/Tsinghua_Journal/turnPage?totalvolume=78&pageno=3"> 阅读</a></td>
